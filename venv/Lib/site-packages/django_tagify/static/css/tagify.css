...
.tagify>.tagify--input:empty::before {
    -webkit-transition: .2s ease-out;
    -o-transition: .2s ease-out;
    transition: .2s ease-out;
    opacity: .5;
...
.tagify>.tagify--input:focus {
    outline: 0;
}

.tagify>.tagify--input:focus::before {
    -webkit-transition: .2s ease-out;
    -o-transition: .2s ease-out;
    transition: .2s ease-out;
    opacity: 0;
...
.tagify>.tagify--input:focus:empty::before {
    -webkit-transition: .2s ease-out;
    -o-transition: .2s ease-out;
    transition: .2s ease-out;
    opacity: .3;
...
.tagify>.tagify--input:empty:focus {
    padding: .3em .5em;
}

.tagify>.tagify--input::before {
